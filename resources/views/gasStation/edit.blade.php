...
@section('content')
    ...
    <form action="{{ route('gasStation.update', ['gasStation' => $gasStation]) }}" method="POST">
        ...
        <div class="form-group pt-2 w-25">
            <label for="priceDieselSpecial">Nová cena nafty</label>
